...
# 2026 Captain 12+ YOS
CAPTAIN_ANNUAL_TFP = 1000  # ~83 TFP/month, typical line
CAPTAIN_RATE = 343.14
GROSS_ANNUAL = round(CAPTAIN_ANNUAL_TFP * CAPTAIN_RATE)  # ~$343,140
...
BASE_STATES = {
    ...
    "AZ": StateTax(
        ...
        estimated_tax=8_579,  # 2.5% of taxable (~$343K)
        sdi_rate=0, sdi_cap=0, sdi_annual=0,
        famli_rate=0, famli_cap=0, famli_annual=0,
        local_tax=0, local_annual=0,
    ...
    "GA": StateTax(
        ...
        estimated_tax=17_818,  # 5.19% flat (reduced from 5.39 in 2025)
        sdi_rate=0, sdi_cap=0, sdi_annual=0,
        famli_rate=0, famli_cap=0, famli_annual=0,
        local_tax=0, local_annual=0,
    ...
    "MD": StateTax(
        ...
        estimated_tax=20_750,  # effective ~6.0% after brackets
        sdi_rate=0, sdi_cap=0, sdi_annual=0,
        famli_rate=0, famli_cap=0, famli_annual=0,
        local_tax=3.2, local_annual=10_980,  # Baltimore County ~3.2%
        notes="6.5% top bracket + LOCAL county tax ~3.2% (varies by county). "
              "BWI is in Anne Arundel County (2.81%). Total effective ~8.8%. "
              "Local tax applies to residents only, not commuters.",
    ),
    ...
    "CA": StateTax(
        ...
        estimated_tax=31_200,  # effective ~9.1% after brackets at $343K
        sdi_rate=1.3, sdi_cap=0, sdi_annual=4_461,  # NO CAP — 1.3% of ALL wages
        famli_rate=0, famli_cap=0, famli_annual=0,
        local_tax=0, local_annual=0,
        notes="13.3% top bracket + SDI 1.3% NO WAGE CAP. SDI applies to BASE "
              "STATE — you pay $4,461/yr SDI even living in TX and commuting. "
              "If based in CA, total hit ~$35,661. Worst tax base by far.",
    ),
}
